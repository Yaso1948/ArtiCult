                                ...
                                <div class="col-lg-8 col-11 mx-auto">
                                    <form role="form" action="" method="post">
                                        <div class="form-floating">
                                            <input type="text" name="nom" id="nom" class="form-control" placeholder="Name" style="margin-bottom: 15px;" required>
                                            <label for="nom">Name</label>
                                        </div>
                                        <div class="form-floating">
                                            <input type="text" name="prenom" id="prenom" class="form-control" placeholder="Surname" style="margin-bottom: 15px;" required>
                                        ...
                                        <div class="form-floating">
                                            <input type="password" name="confirm_password" id="confirm_password" class="form-control" placeholder="Password" required><p style="color:red;" id="confirm_password_debug"> </p>
                                            <script>
