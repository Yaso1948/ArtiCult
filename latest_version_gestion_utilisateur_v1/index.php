            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">
                        ...
                        <strong><span>Art</span>icult</strong>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <?php 
                            if(isset($_SESSION['nom'])){
                                ...
                                $role = $_SESSION['rol'];
                                echo "<button name ='logout 'id='logout' class='bi-person-dash-fill' style='margin-bottom:10px;margin-right:10px;'title='sign-out?'></button>";
                        ...
                        <div class="dropdown">
                            <p id="options" class="bi-gear-fill" style="margin-right: 10px;"></p>
                            <div class="dropdown-content">
                                <a href="View/update_user.php">Update account</a>
                                <a href="View/settings.php">backoffice</a>
                            </div>
                        </div>
                        <div class="dropdown">
                            <p class="bi-person-square" style="margin-top:12px;"></p>
                            <div class="dropdown-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <p>Little Fashion templates comes with <a href="View/sign-in.php">sign in</a> / <a href="View/sign-up.php">sign up</a> pages, product listing / product detail, about, FAQs, and contact page.</p>
