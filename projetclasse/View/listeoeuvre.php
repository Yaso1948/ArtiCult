...
<body>
    ...
    <a href="../View/addOeuvre.php" style="text-decoration: none;">
    <button style="background-color: #4a4a4a; color: #fff; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer; transition: background-color 0.3s; margin-top: 10px;">
        Ajouter une œuvre
    </button>
</a>
</body>
