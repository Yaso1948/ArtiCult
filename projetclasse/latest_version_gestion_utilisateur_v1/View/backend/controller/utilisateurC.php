<?php 
include('C:/xampp/htdocs/trial_3/latest_version_gestion_utilisateur_v1-20231209T173456Z-001/latest_version_gestion_utilisateur_v1/View/backend/configu.php');
...
function listutilisateurs(){
    try{
    $query = (configu::getConnexion())->prepare('SELECT * FROM utilisateurs');
    $query->execute();
    ...
    echo "<h1 style='font-family: Georgia, serif;color:#c3b0e3;margin-top:10px;text-decoration: underline;
    text-underline-offset: 10px;'>Account list:</h1><br><table><tr>
...
function update_utilisateur($utilisateur, $id)
    ...
    function update_utilisateur_backoffice($utilisateur, $id)
    {   
        try {
            $db = configu::getConnexion();
            $query = $db->prepare(
