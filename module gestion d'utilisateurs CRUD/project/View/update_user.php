...
-->
    ...
    <?php echo 'in case of no error, return to settings page manually, i don"t know why it does not work that way'?>
    <body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 mx-auto col-12">
                            ...
                            <h1 class="hero-title text-center mb-5">Update account</h1>                       
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                    <form method="post">
                                        ...
                                        <input type="text" name="cid" placeholder="target" class="form-control" style="margin-right :10px;margin-bottom :20px;"  required>
                                        </div>
                                        <div class="form-floating">
    ...
    $utilisateurc = new utilisateurC() ;
            ...
            $utilisateurc->update_utilisateur($utilisateur,$numeric_id);
